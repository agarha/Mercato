...
**🧰 Implementation repo:** [agarha/mercato-suite](https://github.com/agarha/mercato-suite) — code lives there; this repo is docs.

## Documentation Suite (v2.0.2)
...
Proprietary. © 2026 Mercato. See [LICENSE](LICENSE).
